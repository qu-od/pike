...
ping 127.0.0.1 -n 1 > nul
arm-none-eabi-ld -Tscript.ld -g -o pike.v1.3.x.elf  main.o obj/startup.o obj/lcd.o obj/uart.o obj/init.o obj/wheel.o obj/rsku.o obj/sonar.o obj/motor.o obj/stepper.o
ping 127.0.0.1 -n 1 > nul
arm-none-eabi-objcopy -O binary pike.v1.3.x.elf pike.v1.3.0.bin
